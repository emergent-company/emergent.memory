...
echo ""
echo "CI will build:"
echo "  - CLI binaries (linux/amd64, darwin/amd64, darwin/arm64)"
echo "  - Docker images (ghcr.io/emergent-company/memory-server:$NEW, linux/amd64)"
echo "  - Docker images (ghcr.io/emergent-company/memory-cli:$NEW, linux/amd64)"
