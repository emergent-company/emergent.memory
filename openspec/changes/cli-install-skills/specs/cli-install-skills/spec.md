...
- **WHEN** user runs `emergent install-skills install ./path/to/my-skill`
...
- **WHEN** user runs `emergent install-skills install ./path/to/my-skill --force`
- **AND** `.agents/skills/<skill-name>/` already exists
...
- **WHEN** user runs `emergent install-skills install ./path/to/dir`
...
- **WHEN** user runs `emergent install-skills install ./path --skip-validate`
...
- **WHEN** user runs `emergent install-skills validate ./path/to/skill`
...
- **WHEN** user runs `emergent install-skills list`
...
- **WHEN** user runs `emergent install-skills list --output json`
...
- **WHEN** user runs `emergent install-skills list --dir ./custom/skills`
...
- **WHEN** user runs `emergent install-skills remove my-skill --force`
...
- **WHEN** user runs `emergent install-skills install ./my-skill --dir ./custom/path`
