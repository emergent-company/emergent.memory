...
- `apps/server/migrations/00159_agent_share_links.sql`: `kb.agent_share_links`, `kb.agent_share_sessions`, `kb.agent_share_end_users`, `kb.agent_share_usage`, `kb.agent_tool_approvals.share_link_id`, `kb.agent_share_access_log`.
