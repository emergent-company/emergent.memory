# Spec: search-ranking-signals

## Purpose

Controls how search results are ranked beyond base relevance. Provides optional boost parameters that weight recency and access frequency into the final hybrid search score.
