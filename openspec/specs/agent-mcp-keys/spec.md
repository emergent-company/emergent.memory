...
- **WHEN** a project admin views an agent's configuration
- **THEN** the agent's MCP endpoint and its keys are created, listed, and revoked from that surface
