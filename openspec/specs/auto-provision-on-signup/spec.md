# Capability: Auto-Provision on Signup

## Purpose

Automatically create a default organization and project for new users on first login, so they can start working immediately without manual setup.
