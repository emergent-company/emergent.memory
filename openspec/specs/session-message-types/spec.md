# Spec: session-message-types

## Purpose

Schema pre-registration and embedding policies for Session and Message graph object types, applied at server startup across all projects.
