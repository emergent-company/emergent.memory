# scheduler-stale-job-cleanup Specification

## Purpose
Defines the scheduler's stale-job sweep: never terminal-failing never-started jobs, reaping genuinely stuck in-flight jobs, and surfacing mass reaps observably.
