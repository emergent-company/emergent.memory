# Spec: cli-install-skills-coverage

## Purpose

Coverage requirements for the `memory install-memory-skills` command, including flag behavior, idempotency, and validity of embedded skill manifests.
