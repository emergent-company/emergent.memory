# project-provider-policy Specification

## Purpose
Defines per-project, per-provider policies that control how each project inherits or overrides LLM credentials and model selections from the organization.
