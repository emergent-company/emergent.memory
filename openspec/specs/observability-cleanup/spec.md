# observability-cleanup Specification

## Purpose
Documents the removal of Langfuse and Signoz observability integrations from the platform as part of the migration to Grafana Tempo / OpenTelemetry.
