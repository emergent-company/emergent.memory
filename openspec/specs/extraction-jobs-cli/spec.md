# extraction-jobs-cli Specification

## Purpose
Defines the CLI surface for managing extraction jobs: create, get, list, cancel, retry, and read logs and statistics for a project's extraction jobs.
