# llm-cost-tracking Specification

## Purpose
Tracks multi-modal LLM token usage per project and estimates costs based on a global pricing registry, with support for per-organization custom pricing overrides.
