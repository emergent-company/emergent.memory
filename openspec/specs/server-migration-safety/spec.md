# server-migration-safety Specification

## Purpose
Defines guardrails for server database migrations: preventing a PR from adding a migration below the base branch maximum, a documented escape hatch for deliberate gap fills, explicit remediation for Goose gap failures, and detection of index residue from a recorded out-of-band version.
