# Spec: Agent Skill Catalog

## Purpose

Define how agent definitions declare which skills they may use, how the server filters and injects the skill catalog into the agent's tool pipeline, and how the CLI and blueprint YAML expose the `skills` field.
