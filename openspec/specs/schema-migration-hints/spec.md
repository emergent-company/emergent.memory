# schema-migration-hints Specification

## Purpose
Defines schema migration hints: how schema definitions express migration hints, how hints are validated at publish time, how auto-migration triggers asynchronously on schema assign when hints are present, and how multi-hop migration chains are resolved.
