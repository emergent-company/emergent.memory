...
The `framework/` directory SHALL be a Go package named `e2eframework` under module `github.com/emergent-company/emergent.memory.e2e/framework`. It SHALL NOT contain any `Test*` functions. All test files in the root package SHALL import it as needed.
