...
func NodeHoverCard() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<!-- Hover card: canvas nodes + relation rows --><div id=\"node-hover-card\" class=\"hidden fixed z-[90] pointer-events-none\" style=\"max-width:220px\"><div class=\"bg-gh-surface border border-gh-border rounded-lg shadow-xl overflow-hidden\" style=\"font-size:12px\"><div id=\"nhc-header\" class=\"flex items-center gap-2 px-3 py-2 border-b border-gh-border\"><span id=\"nhc-dot\" class=\"w-2.5 h-2.5 rounded-full shrink-0\"></span> <span id=\"nhc-type\" class=\"text-[10px] tracking-wider font-semibold text-gh-muted\"></span></div><div class=\"px-3 py-2 space-y-1.5\"><div id=\"nhc-name\" class=\"font-medium text-gh-text text-[12px] leading-snug break-words\"></div><div id=\"nhc-props\" class=\"space-y-0.5\"></div><div id=\"nhc-edges\" class=\"text-[10px] text-gh-muted pt-0.5 border-t border-gh-border/40 mt-1\"></div></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
