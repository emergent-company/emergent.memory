  ...
  [
    {
      ...
      requiresDocker: true,
      description:
        'Start the default application stack (API + Admin) under PM2 supervision.',
    },
    {
      ...
      requiresDocker: true,
      description:
        'Ensure every registered application and dependency process is online.',
    },
    {
      ...
      requiresDocker: true,
      description:
        'Start foundational docker dependencies (e.g., Postgres, Zitadel).',
    },
    {
      ...
      requiresDocker: true,
      description:
        'Restart the default application stack with supervised policies enforced.',
    },
    {
    ...
    },
    {
      ...
      requiresDocker: true,
      description:
        'Stop the default application stack and release managed resources.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Render consolidated health snapshot for applications and dependencies.',
    },
    {
    ...
    },
    {
      ...
      requiresDocker: false,
      description:
        'Install dependencies and prepare the admin workspace for development.',
    },
    {
      ...
      requiresDocker: false,
      description:
        'Launch the admin Vite development server under PM2 supervision.',
    },
    {
    ...
    },
    {
      ...
      requiresDocker: false,
      description:
        'Execute admin project tests with standardized environment setup.',
    },
  ];
