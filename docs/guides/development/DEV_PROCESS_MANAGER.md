...
The custom process manager previously documented here has been fully retired. The repository now standardizes on the Workspace CLI (`workspace:*` scripts) that uses a PID-based process manager and Nx targets.
