...
[ERROR] Unhandled non-HTTP exception: error: column "project_id" does not exist
    at /path/to/emergent.memory/node_modules/pg/lib/client.js:545:17
    at DatabaseService.query (/path/to/emergent.memory/apps/server/src/common/database/database.service.ts:166:24)
    at SchemaRegistryService.getObjectValidator (/path/to/emergent.memory/apps/server/src/modules/graph/schema-registry.service.ts:38:21)
```
