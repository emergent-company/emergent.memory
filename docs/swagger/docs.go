...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/docs": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of documentation with metadata",
                        "schema": {
                            "$ref": "#/definitions/documentation.DocumentList"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/documentation.CategoriesResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
        ...
        "/api/docs/{slug}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Document slug (e.g., template-pack-creation)",
                        "name": "slug",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/documentation.Document"
                        }
                    },
                    "404": {
        ...
        "/api/v2/documents/deletion-impact": {
            "post": {
                "security": [
                    {
                        "bearerAuth": []
        ...
        "/api/v2/documents/{id}/deletion-impact": {
            "get": {
                "security": [
                    {
                        "bearerAuth": []
        ...
        "/api/v2/graph/embedding-policies": {
            "get": {
                "security": [
                    {
                        "bearerAuth": []
        ...
        "/api/v2/graph/embedding-policies/{id}": {
            "get": {
                "security": [
                    {
                        "bearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/documentation.HealthResponse"
                        }
                    },
                    "503": {
    ...
    "definitions": {
        "documentation.CategoriesResponse": {
            "type": "object",
            "properties": {
                "categories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/documentation.CategoryInfo"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "documentation.DocumentList": {
            ...
            "properties": {
                "documents": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/documentation.DocumentMeta"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "documentation.HealthResponse": {
            "type": "object",
            "properties": {
                "checks": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/documentation.Check"
                    }
                },
                "status": {
                    "type": "string"
        ...
        "domain_graph.GraphRelationship": {
            ...
            "properties": {
                ...
                "src": {
                    "description": "Populated by joins",
                    "allOf": [
                        {
                            "$ref": "#/definitions/domain_graph.GraphObject"
                        }
