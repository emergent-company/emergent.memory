...
The agent sandbox system supports three providers, each with different trade-offs. The system automatically selects the best available provider, but you can override the default.
...
- **Agent sandboxes** prefer Firecracker (stronger isolation for arbitrary code execution)
