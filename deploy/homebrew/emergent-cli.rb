class EmergentCli < Formula
  ...
  homepage "https://github.com/emergent-company/emergent"
  version "0.2.1"
  license "Apache-2.0"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/emergent-company/emergent/releases/download/cli-v0.2.1/emergent-cli-darwin-arm64.tar.gz"
      sha256 "f4da3e7e44476a7e96eee0dedf15b8ffaa72719a434158324d742878349d6db8"
    else
      url "https://github.com/emergent-company/emergent/releases/download/cli-v0.2.1/emergent-cli-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/emergent-company/emergent/releases/download/cli-v0.2.1/emergent-cli-linux-arm64.tar.gz"
      sha256 "1a6a3e175f3e4231d352e53fd5ec2b67047d21603a9aadce7aa88a7ee4cdcdcc"
    else
      url "https://github.com/emergent-company/emergent/releases/download/cli-v0.2.1/emergent-cli-linux-amd64.tar.gz"
