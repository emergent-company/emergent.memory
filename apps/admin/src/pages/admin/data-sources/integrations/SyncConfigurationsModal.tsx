...
import { ScheduleInput } from '@/components/molecules/form';
import {
  SyncOptionsForm,
  type SyncOptions,
  type FolderRef,
        ...
        <ScheduleInput
          ...
          value={
            formData.schedule?.enabled
              ? formData.schedule.cronSchedule ?? undefined
              : undefined
          }
          onChange={(cron) =>
            setFormData((prev) => ({
              ...prev,
              schedule: cron
                ? { enabled: true, cronSchedule: cron }
                : { enabled: false },
            }))
          }
          allowManual={true}
          manualLabel="Manual Only"
          scheduledLabel="Automatic"
          showNextRun={true}
          description="Configure automatic sync on a recurring schedule"
        />
