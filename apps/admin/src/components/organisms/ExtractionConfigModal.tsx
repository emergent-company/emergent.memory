          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-3">
              <div className="flex items-center gap-2">
                ...
                <Tooltip
                  placement="right"
                  content="Entities below this confidence will be rejected and not created"
                >
                  <Icon
                    icon="lucide--info"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="flex items-center gap-2">
                ...
                <Tooltip
                  placement="right"
                  content="Entities at or above this confidence will be marked as 'accepted', below will be 'draft'"
                >
                  <Icon
                    icon="lucide--info"
                    className="size-3.5 text-base-content/60 cursor-help"
          ...
          <div className="space-y-4 mb-6">
            <div className="grid lg:grid-cols-2 gap-4 items-center">
              <div className="flex items-center gap-2">
                ...
                <Tooltip
                  placement="right"
                  content="Extracted entities will need manual review before being added to the knowledge base"
                >
                  <Icon
                    icon="lucide--info"
            ...
            <div className="grid lg:grid-cols-2 gap-4 items-center">
              <div className="flex items-center gap-2">
                ...
                <Tooltip
                  placement="right"
                  content="You will receive a notification when the extraction process is complete"
                >
                  <Icon
                    icon="lucide--info"
                    className="size-4 text-base-content/60 cursor-help"
