...
// The model catalog, the skill list, and the project's pinned default model
// are best-effort: the create/edit dialog falls back to a free-choice model
// list, an empty skill picker, and the generic "Auto — default model" label
