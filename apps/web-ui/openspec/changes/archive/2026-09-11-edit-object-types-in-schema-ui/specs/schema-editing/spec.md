...
The Schema area SHALL let a user edit an object type's description and typed properties (adding, removing, and changing properties) and persist the change; the type name SHALL be immutable on edit.
