...
func PageLayout(projectID, branchID string, typeColors map[string]string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<!-- In-page confirm dialog (replaces window.confirm for DevTools compatibility) --><dialog id=\"confirm-dialog\" class=\"bg-gh-surface border border-gh-border rounded-lg shadow-xl p-5 text-gh-text max-w-sm w-full\" style=\"color:#e6edf3;background:#161b22;border:1px solid #30363d;border-radius:8px;padding:20px;max-width:380px;width:100%\"><p id=\"confirm-dialog-msg\" class=\"text-[13px] mb-4 leading-relaxed whitespace-pre-wrap\" style=\"font-size:13px;margin-bottom:16px;line-height:1.5;white-space:pre-wrap\"></p><div class=\"flex justify-end gap-2\" style=\"display:flex;justify-content:flex-end;gap:8px\"><button id=\"confirm-dialog-cancel\" class=\"btn btn-xs btn-ghost border border-gh-border text-gh-muted normal-case\" style=\"font-size:12px;padding:4px 12px;cursor:pointer\">Cancel</button> <button id=\"confirm-dialog-ok\" class=\"btn btn-xs normal-case\" style=\"font-size:12px;padding:4px 12px;background:#58a6ff;color:#fff;border:none;border-radius:4px;cursor:pointer\">Continue</button></div></dialog>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<script type=\"module\" src=\"/static/graph_explore.js\"></script></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func NodeHoverCard() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<!-- Hover card: canvas nodes + relation rows --><div id=\"node-hover-card\" class=\"hidden fixed z-[90] pointer-events-none\" style=\"max-width:360px\"><div class=\"bg-gh-surface border border-gh-border rounded-lg shadow-xl overflow-hidden\" style=\"font-size:12px\"><div id=\"nhc-header\" class=\"flex items-center gap-2 px-3 py-2 border-b border-gh-border\"><span id=\"nhc-dot\" class=\"w-2.5 h-2.5 rounded-full shrink-0\"></span> <span id=\"nhc-type\" class=\"text-[10px] tracking-wider font-semibold text-gh-muted\"></span></div><div class=\"px-3 py-2 space-y-1.5\"><div id=\"nhc-name\" class=\"font-medium text-gh-text text-[12px] leading-snug break-words\"></div><div id=\"nhc-props\" class=\"space-y-0.5\"></div><div id=\"nhc-edges\" class=\"text-[10px] text-gh-muted pt-0.5 border-t border-gh-border/40 mt-1\"></div></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
