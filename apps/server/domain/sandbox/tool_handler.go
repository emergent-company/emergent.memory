...
// BashTool handles POST /api/v1/agent/sandboxes/:id/bash
...
// @Router       /api/v1/agent/sandboxes/{id}/bash [post]
// @Security     bearerAuth
...
// ReadTool handles POST /api/v1/agent/sandboxes/:id/read
// @Summary      Read file
...
// @Router       /api/v1/agent/sandboxes/{id}/read [post]
// @Security     bearerAuth
...
// WriteTool handles POST /api/v1/agent/sandboxes/:id/write
// @Summary      Write file
...
// @Failure      400 {object} apperror.Error "Bad request"
// @Failure      401 {object} apperror.Error "Unauthorized"
// @Router       /api/v1/agent/sandboxes/{id}/write [post]
// @Security     bearerAuth
...
// EditTool handles POST /api/v1/agent/sandboxes/:id/edit
// @Summary      Edit file
...
// @Failure      401 {object} apperror.Error "Unauthorized"
// @Failure      404 {object} apperror.Error "File not found"
// @Router       /api/v1/agent/sandboxes/{id}/edit [post]
// @Security     bearerAuth
...
// GlobTool handles POST /api/v1/agent/sandboxes/:id/glob
...
// @Failure      400 {object} apperror.Error "Bad request"
// @Failure      401 {object} apperror.Error "Unauthorized"
// @Router       /api/v1/agent/sandboxes/{id}/glob [post]
// @Security     bearerAuth
...
// GrepTool handles POST /api/v1/agent/sandboxes/:id/grep
...
// @Failure      400 {object} apperror.Error "Bad request"
// @Failure      401 {object} apperror.Error "Unauthorized"
// @Router       /api/v1/agent/sandboxes/{id}/grep [post]
// @Security     bearerAuth
...
// GitTool handles POST /api/v1/agent/sandboxes/:id/git
...
// @Failure      400 {object} apperror.Error "Bad request"
// @Failure      401 {object} apperror.Error "Unauthorized"
// @Router       /api/v1/agent/sandboxes/{id}/git [post]
// @Security     bearerAuth
