...
func (m *MCPHostingService) startExistingServer(ctx context.Context, ws *AgentSandbox) error {
	if ws.ProviderWorkspaceID == "" {
...
func (m *MCPHostingService) buildStatusFromWorkspace(ws *AgentSandbox) *MCPServerStatus {
