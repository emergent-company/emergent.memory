...
// ContainerType distinguishes between agent sandboxes and MCP server containers.
...
// AgentSandbox represents a row in the kb.agent_sandboxes table.
type AgentSandbox struct {
	bun.BaseModel `bun:"table:kb.agent_sandboxes,alias:aw"`
