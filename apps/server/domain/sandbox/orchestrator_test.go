...
func TestOrchestratorSelectExplicit(t *testing.T) {
	...
	p, pt, err := o.SelectProvider(ContainerTypeAgentSandbox, DeploymentSelfHosted, ProviderGVisor)
...
func TestOrchestratorSelectExplicitNotFound(t *testing.T) {
	...
	_, _, err := o.SelectProvider(ContainerTypeAgentSandbox, DeploymentSelfHosted, ProviderFirecracker)
	assert.Error(t, err)
...
func TestOrchestratorSelectExplicitUnhealthy(t *testing.T) {
	...
	_, _, err := o.SelectProvider(ContainerTypeAgentSandbox, DeploymentSelfHosted, ProviderGVisor)
	assert.Error(t, err)
...
func TestOrchestratorAutoSelectSelfHostedWorkspace(t *testing.T) {
	...
	p, pt, err := o.SelectProvider(ContainerTypeAgentSandbox, DeploymentSelfHosted, "")
	require.NoError(t, err)
...
func TestOrchestratorAutoSelectManaged(t *testing.T) {
	...
	p, pt, err := o.SelectProvider(ContainerTypeAgentSandbox, DeploymentManaged, "")
	require.NoError(t, err)
...
func TestOrchestratorFallbackNoExplicit(t *testing.T) {
	...
	_, _, err := o.SelectProviderWithFallback(ContainerTypeAgentSandbox, DeploymentSelfHosted, ProviderFirecracker)
	assert.Error(t, err)
}
...
func TestOrchestratorFallbackAuto(t *testing.T) {
	...
	p, pt, err := o.SelectProviderWithFallback(ContainerTypeAgentSandbox, DeploymentSelfHosted, "auto")
	require.NoError(t, err)
	assert.Equal(t, ProviderGVisor, pt)
	assert.NotNil(t, p)
}
...
func TestOrchestratorNoProviders(t *testing.T) {
	...
	_, _, err := o.SelectProvider(ContainerTypeAgentSandbox, DeploymentSelfHosted, "")
	assert.Error(t, err)
