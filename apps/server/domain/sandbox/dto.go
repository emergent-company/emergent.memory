...
// ToResponse converts an AgentSandbox entity to a WorkspaceResponse.
func ToResponse(ws *AgentSandbox) *WorkspaceResponse {
...
// ToResponseList converts a slice of AgentSandbox entities to WorkspaceResponses.
func ToResponseList(workspaces []*AgentSandbox) []*WorkspaceResponse {
