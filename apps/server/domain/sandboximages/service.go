...
func (s *Service) Resolve(ctx context.Context, projectID, name string) (*SandboxImage, error) {
...
func (s *Service) Create(ctx context.Context, projectID string, req *CreateSandboxImageRequest) (*SandboxImage, error) {
...
func (s *Service) List(ctx context.Context, projectID string) ([]*SandboxImage, error) {
