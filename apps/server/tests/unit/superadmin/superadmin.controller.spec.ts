...
describe('SuperadminController', () => {
  ...
  let mockGraphJobRepo: ReturnType<typeof createMockRepository>;
  let mockChunkJobRepo: ReturnType<typeof createMockRepository>;
  let mockExtractionJobRepo: ReturnType<typeof createMockRepository>;
  let mockDocumentParsingJobRepo: ReturnType<typeof createMockRepository>;
  let mockSyncJobRepo: ReturnType<typeof createMockRepository>;
  let mockIntegrationRepo: ReturnType<typeof createMockRepository>;
  ...
  beforeEach(() => {
    ...
    mockGraphJobRepo = createMockRepository();
    mockChunkJobRepo = createMockRepository();
    mockExtractionJobRepo = createMockRepository();
    mockDocumentParsingJobRepo = createMockRepository();
    mockSyncJobRepo = createMockRepository();
    mockIntegrationRepo = createMockRepository();
    ...
    controller = new SuperadminController(
      ...
      mockGraphJobRepo as any,
      mockChunkJobRepo as any,
      mockExtractionJobRepo as any,
      mockDocumentParsingJobRepo as any,
