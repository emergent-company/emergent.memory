...
const EXPECTED: Record<string, string[]> = {
  'delete /admin/agents/{id}': ['admin:write'],
  ...
  'delete /data-source-integrations/{id}': ['data-sources:delete'],
  'delete /data-source-integrations/{id}/sync-configurations/{configId}': [
    'data-sources:delete',
  ],
  'delete /discovery-jobs/{jobId}': ['discovery:write'],
  'delete /documents': ['documents:delete'],
  'delete /documents/{id}': ['documents:delete'],
  'delete /external-sources/{id}': ['documents:delete'],
  ...
  'delete /invites/{id}': ['project:admin'],
  ...
  'delete /projects/{projectId}/tokens/{tokenId}': ['project:read'],
  'delete /tags/{id}': ['graph:write'],
  'delete /template-packs/projects/{projectId}/assignments/{assignmentId}': [
    'graph:write',
  ],
  'delete /template-packs/studio/cleanup/empty-drafts': ['templates:write'],
  'delete /template-packs/studio/session/{sessionId}': ['templates:write'],
  'delete /template-packs/studio/sessions/empty': ['templates:write'],
  ...
  'get /admin/agents/{id}/pending-events': ['admin:read'],
  ...
  'get /admin/user-sync/status': ['admin:read'],
  'get /admin/user-sync/users-needing-sync': ['admin:read'],
  ...
  'get /data-source-integrations': ['data-sources:read'],
  'get /data-source-integrations/oauth/status': ['data-sources:read'],
  'get /data-source-integrations/providers': ['data-sources:read'],
  'get /data-source-integrations/providers/{providerType}/schema': [
    'data-sources:read',
  ],
  'get /data-source-integrations/source-types': ['data-sources:read'],
  'get /data-source-integrations/{id}': ['data-sources:read'],
  'get /data-source-integrations/{id}/folder-config': ['data-sources:read'],
  'get /data-source-integrations/{id}/sync-configurations': [
    'data-sources:read',
  ],
  'get /data-source-integrations/{id}/sync-configurations/{configId}': [
    'data-sources:read',
  ],
  'get /data-source-integrations/{id}/sync-jobs': ['data-sources:read'],
  'get /data-source-integrations/{id}/sync-jobs/latest': ['data-sources:read'],
  'get /data-source-integrations/{id}/sync-jobs/{jobId}': ['data-sources:read'],
  'get /discovery-jobs/projects/{projectId}': ['discovery:read'],
  'get /discovery-jobs/{jobId}': ['discovery:read'],
  'get /document-parsing-jobs': ['documents:read'],
  'get /document-parsing-jobs/{id}': ['documents:read'],
  'get /document-parsing-jobs/{id}/download': ['documents:read'],
  'get /documents': ['documents:read'],
  'get /documents/source-types': ['documents:read'],
  'get /documents/unchunked': ['documents:read'],
  'get /documents/{id}': ['documents:read'],
  'get /documents/{id}/content': ['documents:read'],
  'get /documents/{id}/deletion-impact': ['documents:delete'],
  'get /documents/{id}/download': ['documents:read'],
  'get /external-sources': ['documents:read'],
  'get /external-sources/{id}': ['documents:read'],
  ...
  'get /objects/{objectId}/refinement-chat': ['graph:read'],
  'get /objects/{objectId}/refinement-chat/messages': ['graph:read'],
  ...
  'get /projects/{id}/invites': ['project:read'],
  'get /projects/{id}/members': ['project:read'],
  'get /projects/{projectId}/tokens': ['project:read'],
  'get /projects/{projectId}/tokens/{tokenId}': ['project:read'],
  'get /prompts/{name}': ['settings:read'],
  'get /search': ['search:read'],
  'get /tags': ['graph:read'],
  'get /tags/by-name/{name}': ['graph:read'],
  'get /tags/{id}': ['graph:read'],
  'get /tasks': ['tasks:read'],
  'get /tasks/all': ['tasks:read'],
  'get /tasks/all/counts': ['tasks:read'],
  'get /tasks/counts': ['tasks:read'],
  'get /tasks/{id}': ['tasks:read'],
  'get /tasks/{id}/merge-chat': ['tasks:read'],
  'get /tasks/{id}/merge-chat/messages': ['tasks:read'],
  'get /tasks/{id}/merge-suggestion': ['tasks:read'],
  ...
  'get /template-packs/studio/session/{sessionId}': ['templates:read'],
  'get /template-packs/studio/session/{sessionId}/messages': ['templates:read'],
  'get /template-packs/studio/sessions': ['templates:read'],
  ...
  'get /users/search': ['org:read'],
  'patch /admin/agents/{id}': ['admin:write'],
  'patch /admin/extraction-jobs/{jobId}': ['extraction:write'],
  'patch /chat/{id}': ['chat:admin'],
  'patch /data-source-integrations/{id}': ['data-sources:write'],
  'patch /data-source-integrations/{id}/folder-config': ['data-sources:write'],
  'patch /data-source-integrations/{id}/sync-configurations/{configId}': [
    'data-sources:write',
  ],
  'patch /external-sources/{id}': ['documents:write'],
  ...
  'patch /template-packs/studio/session/{sessionId}/name': ['templates:write'],
  ...
  'post /admin/agents': ['admin:write'],
  'post /admin/agents/{id}/batch-trigger': ['admin:write'],
  ...
  'post /admin/user-sync/trigger': ['admin:write'],
  'post /admin/user-sync/user/{userId}': ['admin:write'],
  'post /chat/conversations': ['chat:use'],
  'post /chat/stream': ['chat:use'],
  'post /data-source-integrations': ['data-sources:write'],
  'post /data-source-integrations/oauth/google/start': ['data-sources:write'],
  'post /data-source-integrations/test-config': ['data-sources:write'],
  'post /data-source-integrations/{id}/browse': ['data-sources:read'],
  'post /data-source-integrations/{id}/folder-count': ['data-sources:read'],
  'post /data-source-integrations/{id}/import': ['data-sources:write'],
  'post /data-source-integrations/{id}/sync': ['data-sources:write'],
  'post /data-source-integrations/{id}/sync-configurations': [
    'data-sources:write',
  ],
  'post /data-source-integrations/{id}/sync-configurations/{configId}/run': [
    'data-sources:write',
  ],
  'post /data-source-integrations/{id}/sync-jobs/{jobId}/cancel': [
    'data-sources:write',
  ],
  'post /data-source-integrations/{id}/sync-preview': ['data-sources:read'],
  'post /data-source-integrations/{id}/test-connection': ['data-sources:read'],
  'post /discovery-jobs/projects/{projectId}/start': ['discovery:write'],
  'post /discovery-jobs/{jobId}/finalize': ['discovery:write'],
  'post /document-parsing-jobs/upload': ['documents:write'],
  'post /documents': ['documents:write'],
  'post /documents/bulk-chunk-unchunked': ['documents:write'],
  'post /documents/deletion-impact': ['documents:delete'],
  'post /documents/{id}/cancel-conversion': ['documents:write'],
  'post /documents/{id}/recreate-chunks': ['documents:write'],
  'post /documents/{id}/retry-conversion': ['documents:write'],
  'post /external-sources/import': ['documents:write'],
  'post /external-sources/{id}/sync': ['documents:write'],
  ...
  'post /invites/{id}/decline': ['org:read'],
  ...
  'post /objects/{objectId}/refinement-chat': ['graph:write'],
  'post /objects/{objectId}/refinement-chat/apply': ['graph:write'],
  'post /objects/{objectId}/refinement-chat/reject': ['graph:write'],
  'post /product-versions': ['graph:write'],
  'post /projects': ['org:project:create'],
  'post /projects/{projectId}/tokens': ['project:read'],
  'post /search/unified': ['search:read'],
  'post /tags': ['graph:write'],
  'post /tasks/{id}/cancel': ['tasks:write'],
  'post /tasks/{id}/merge-chat': ['tasks:write'],
  'post /tasks/{id}/merge-chat/apply': ['tasks:write'],
  'post /tasks/{id}/merge-chat/reject': ['tasks:write'],
  ...
  'post /template-packs/studio': ['templates:write'],
  'post /template-packs/studio/session/{sessionId}/apply': ['templates:write'],
  'post /template-packs/studio/session/{sessionId}/chat': ['templates:write'],
  'post /template-packs/studio/session/{sessionId}/reject': ['templates:write'],
  'post /template-packs/studio/session/{sessionId}/save': ['templates:write'],
  'post /template-packs/studio/{packId}': ['templates:write'],
  ...
  'put /prompts/{name}': ['settings:write'],
