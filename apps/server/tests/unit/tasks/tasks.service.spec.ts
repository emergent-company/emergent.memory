...
describe('TasksService', () => {
  ...
  const mockUserAccessService = {
    getAccessTree: vi.fn().mockResolvedValue([]),
  };

  const mockSuggestionTaskHandlerService = {
    isSuggestionTask: vi.fn().mockReturnValue(false),
    applySuggestion: vi.fn(),
    getSuggestionSummary: vi.fn(),
  };
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: SuggestionTaskHandlerService,
          useValue: mockSuggestionTaskHandlerService,
        },
      ],
    }).compile();
    ...
    (service as any).userAccessService = mockUserAccessService;
    (service as any).suggestionTaskHandler = mockSuggestionTaskHandlerService;
  });
