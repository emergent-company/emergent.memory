...
describe('ProjectsService', () => {
  ...
  const createUserProfileRepo = () => createMockRepository();
  const createUserEmailRepo = () => createMockRepository();
  ...
  it('list returns empty for invalid orgId shape', async () => {
    ...
    const userProfileRepo = createUserProfileRepo();
    const userEmailRepo = createUserEmailRepo();
