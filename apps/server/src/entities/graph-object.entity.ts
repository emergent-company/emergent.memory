...
/**
 * Type of actor that created/modified a graph object
 * - 'user': A human user via the UI or API
 * - 'agent': An automated agent
 * - 'system': System-level operations (migrations, imports, etc.)
 */
...
export class GraphObject {
  ...
  /**
   * Type of actor that created/last modified this object
   * Used for reaction agent loop prevention
   */
  @Column({ name: 'actor_type', type: 'text', default: 'user' })
  actorType!: ActorType;

  /**
   * UUID of the user or agent that created/last modified this object
